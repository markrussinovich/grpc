...
grpc_cc_library(
    name = "grpc_transport_shmem",
    srcs = [
    "//src/core/ext/transport/shmem:shmem_transport.cc",
    "//src/core/ext/transport/shmem:shmem_framer.cc",
    ...
    "//src/core/ext/transport/shmem:shmem_framer.h",
    "//src/core/ext/transport/shmem:shmem_queue.h",
